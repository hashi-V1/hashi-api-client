 ...
 */
export declare function approveAndLockEthereum(chain: Chain, token: Token, destinationAddress: string, signer: Signer): Promise<number>;
/**
 ...
 */
export declare function wrapTokenEthereum(chain: Chain, message: UnsignedMessageType, signatures: Signature[], signer: Signer): Promise<WrappedTokenType>;
/**
 ...
 */
export declare function burnTokenEthereum(chain: Chain, token: LockedTokenType, destinationAddress: string, signer: Signer): Promise<void>;
/**
 ...
 * @returns an empty promise
 */
export declare function withdrawTokenEthereum(chain: Chain, message: UnsignedMessageType, signatures: Signature[], signer: Signer): Promise<void>;
